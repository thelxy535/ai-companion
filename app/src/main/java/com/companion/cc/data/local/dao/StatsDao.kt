...
interface StatsDao {
    ...
    """)
    suspend fun getTotalMessagesForCompanion(userId: String, companionId: String): Int
    ...
    @Query("""
        ...
        WHERE user_id = :userId AND companion_id = :companionId
    """)
    suspend fun getTotalDaysForCompanion(userId: String, companionId: String): Int
    ...
    @Query("""
        ...
        GROUP BY companion_id
    """)
    suspend fun getCompanionStatsForCompanion(userId: String, companionId: String): List<CompanionStatRow>
    ...
    @Query("""
        ...
        ORDER BY date DESC
    """)
    suspend fun getMessageCountByDateForCompanion(userId: String, companionId: String): List<DateCountRow>
    ...
    @Query("""
        ...
        ORDER BY timestamp ASC
    """)
    suspend fun getMessagesByDateForCompanion(
        userId: String,
        companionId: String,
        date: String
    ): List<MessageEntity>
    ...
    @Query("""
        ...
        WHERE user_id = :userId AND companion_id = :companionId
    """)
    suspend fun deleteAllMessagesForCompanion(userId: String, companionId: String)
